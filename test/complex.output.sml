...
val z = { a = (1 + 2) : string, b = Foo "hi" #"x", c = List.map (fn x => Fn.id x + 1), stuff = [1, 2, f [#1 o #foo bar, 3]], things = raise Fail (#2 "wow") x before print "hi" }
...
datatype foo = Foo | Bar of int | Baz | More of t * int | Qux of string * int * bool
